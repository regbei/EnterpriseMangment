...
class AccountPolicy
{
    ...
    {
        return in_array($user->role_id, [Role::Admin,Role::Accountant]) ? Response::allow() : Response::deny('Belongs To Accountant ONLY ):');    
    ...
    {
        return $user->role_id == Role::Accountant ? Response::allow() : Response::deny('Belongs To Accountant ONLY ):');    
